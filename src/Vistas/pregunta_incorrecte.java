...
public class pregunta_incorrecte extends JFrame {
	...
	public pregunta_incorrecte(String respuesta) {
		...
		setBounds(100, 100, 444, 376);
		contentPane = new JPanel();
		contentPane.setBackground(Color.DARK_GRAY);
		contentPane.setBorder(new EmptyBorder(5, 5, 5, 5));
		setContentPane(contentPane);
		GridBagLayout gbl_contentPane = new GridBagLayout();
		gbl_contentPane.columnWidths = new int[]{428, 0};
		gbl_contentPane.rowHeights = new int[]{32, 56, 44, 38, 47, 37, 0};
		...
		gbc_solucion.insets = new Insets(0, 0, 5, 0);
	...
	public pregunta_incorrecte(String respuesta, String nombre) {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 444, 376);
		contentPane = new JPanel();
		contentPane.setBackground(Color.DARK_GRAY);
		...
		JLabel lblNewLabel_1 = new JLabel("Pregunta Incorrecta  ! MAl: " + nombre);
		lblNewLabel_1.setFont(new Font("Dialog", Font.BOLD, 24));
		lblNewLabel_1.setForeground(Color.RED);
		GridBagConstraints gbc_lblNewLabel_1 = new GridBagConstraints();
		gbc_lblNewLabel_1.insets = new Insets(0, 0, 5, 0);
